...
public class WoodShadeBroomItem <T> extends BroomItem{
    public WoodShadeBroomItem(RegistryObject<T> registryObject, Properties settings) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new WoodShadeBroomItemRenderer();
